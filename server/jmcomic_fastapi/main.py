...
class JmcomicService:
    ...
    def __init__(self, impl: str = "api", domain_list: Sequence[str] | None = None):
        ...
        if _logs_disabled():
            disable_jm_log()
        self._client = JmOption.default().new_jm_client(
            impl=self.impl, domain_list=self.domain_list
        )
...
async def search_manga(
    ...
    return service.search(
        query, page, page_size, filter_category, filter_time, sort, order, filter_tag
    )
